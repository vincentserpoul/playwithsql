...
echo "[" > results.log
./infra/databases/docker_swarm/cockroachdb/launch-solo.sh && ./run-docker.sh cockroachdb pws_cockroachdb 100 5ms 100;
./infra/databases/docker_swarm/mssql/launch-solo.sh && ./run-docker.sh mssql pws_mssql 100 5ms 3;
./infra/databases/docker_swarm/mysql/launch-solo.sh && ./run-docker.sh mysql pws_mysql 100 5ms 100;
