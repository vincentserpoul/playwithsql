...
./infra/databases/swarm/oracle/launch-solo.sh && ./bench/status/swarm/run-bench.sh oracle oracle $SCH 100000 10;
...
./bench/status/swarm/run-bench.sh sqlite pws_sqlite $SCH 100000 10;
